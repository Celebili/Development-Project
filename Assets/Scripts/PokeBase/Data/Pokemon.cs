    ...
    public void SetStatus(ConditionID conditionID)
    {
        ...
        switch(conditionID)
        {
            case ConditionID.psn: case ConditionID.hyp:
                ...
                if(Base.Type1 == PokemonType.Poison || Base.Type2 == PokemonType.Poison) { StatusChange.Enqueue("没有效果..."); return; }

            break;

            case ConditionID.brn:

                if(Base.Type1 == PokemonType.Fire || Base.Type2 == PokemonType.Fire) { StatusChange.Enqueue("没有效果..."); return; }

            break;

            case ConditionID.frz:

                if(Base.Type1 == PokemonType.Ice || Base.Type2 == PokemonType.Ice) { StatusChange.Enqueue("没有效果..."); return; }

            break;

            case ConditionID.par:

                if(Base.Type1 == PokemonType.Electric || Base.Type2 == PokemonType.Electric) { StatusChange.Enqueue("没有效果..."); return; }
