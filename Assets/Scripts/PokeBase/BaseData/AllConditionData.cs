    ...
    {
        {
            ...
            new Condition()
            {
                ...
                OnAfterTurn = (Pokemon pokemon) =>
                {
                    ...
                    pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " hurt by poison!"));
                }
            }
        },

        {
            ...
            {
                Name = "剧毒",
                StartMessage = " is badly poisoned",
                ...
                OnAfterTurn = (Pokemon pokemon) =>
                {
                    ...
                    pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " hurt by badly poison!"));
                }
            }
        },

        {
            ...
            new Condition()
            {
                ...
                OnAfterTurn = (Pokemon pokemon) =>
                {
                    ...
                    pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " hurt by burn!"));
                }
            }
        },

        {
            ...
            {
                Name = "麻痹",
                StartMessage = " is paralysised",
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    if(Random.Range(1, 5) == 1)
                    {
                        pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " paralysis, can't take action!"));
                        return false;
                    }
                    return true;
                }
...

        {
            ...
            {
                Name = "冰冻",
                StartMessage = "is freezed",
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    if(Random.Range(1, 5) == 1)
                    {
                        pokemon.CureStatus();
                        pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, "is defrosted!"));
                        return true;
                    }
                    pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " is freezed, can't take action!"));
                    return false;
                }
            }
        },

        {
            ...
            new Condition()
            {
                ...
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    ...
                    {
                        pokemon.CureStatus();
                        pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " awake!"));
                        return true;
                    }
                    pokemon.StatusTime--;
                    pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " is sleeping..."));
                    return false;
                }
            }
        },
            ...
            new Condition()
            {
                ...
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    if(pokemon.VolatileStatusTime <= 0)
                    {
                        ...
                        pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " sober up!"));
                        return true;
                    }
                    ...
                    pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " is confused..."));
                    ...
                    pokemon.StatusChange.Enqueue($" attack itself...");
                    return false;
                }
            }
        },

        {
            ...
            new Condition()
            {
                ...
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    ...
                    pokemon.VolatileStatusTime--;
                    pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " is flinch..."));
                    return false;
                }
            }
        },

        {
            ...
            new Condition()
            {
                ...
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    ...
                    {
                        pokemon.StatusChange.Enqueue(string.Concat(pokemon.NickName, " is infatuated..."));
                        return false;
                    }
                }
            }
