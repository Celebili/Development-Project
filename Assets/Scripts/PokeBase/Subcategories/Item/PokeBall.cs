    ...
    public float CatchRate(int times, Pokemon playerPokemon, Pokemon enemyPokemon)
    {
        switch(pokeBallType)
		{
			...
			case PokeBallType.Type:
			    ...
			    if(enemyPokemon.Base.Type1 == PokemonType.Water || enemyPokemon.Base.Type1 == PokemonType.Bug
				|| enemyPokemon.Base.Type2 == PokemonType.Water || enemyPokemon.Base.Type2 == PokemonType.Bug)
				{
					return 3.5f;
				}
				/*if(pb.ID == 17)//捕网球
